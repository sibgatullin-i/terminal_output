...
import os,pandas,json,datetime,time,requests,tabulate,sys
#import eikon as terminal

# Displaying the parent directory of the script
script_rootFolder = os.path.dirname(__file__)
#sscript_inputFolder = os.path.join(script_rootFolder,sys.argv[1])
...
print(tabulate.tabulate(extraSortedData))
#todo date convert
""" 
